...
col1.metric(label="Nombre d'entraînements en 2022", value=(df.index.year == 2022).sum())
col2.metric(label="Nombre d'entraînements en 2023", value=(df.index.year == 2023).sum())
col3.metric(label="Nombre d'entraînements en 2024", value=(df.index.year == 2024).sum())
